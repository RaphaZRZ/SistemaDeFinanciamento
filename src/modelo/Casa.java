...
public class Casa extends Financiamento{
    ...
    public Casa(int codigo, String tipoDoImovel, double valorCasa, int prazoFinanciamentoEmAnos, double taxaJurosAnual, double areaConstruida, double areaTerreno) {
        super(codigo, tipoDoImovel, valorCasa, prazoFinanciamentoEmAnos, taxaJurosAnual);
